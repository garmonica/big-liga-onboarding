...
/* harmony import */ var _modules_loader__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_loader__WEBPACK_IMPORTED_MODULE_3__);
...
var loaderText = document.querySelector('.header__text');
var introHeading = document.querySelector('.intro__heading');
...
if (document.body.clientWidth <= TABLET_WIDTH) {
  ...
  if (loader) {
    var onLoaderClick = function onLoaderClick(evt) {
      evt.stopPropagation();
      header.classList.remove('header--loader');
      header.classList.add('header--closed');
      introHeading.classList.add('intro__heading--opened');
